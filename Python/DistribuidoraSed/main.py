...
def main():
    ...
    proveesor_singleton = ProveedorSingleton()
    proveesor_singleton.registrar(proveedor_a)
    proveesor_singleton.registrar(proveedor_b)
    print "Proveedor 01",proveesor_singleton.validar_existencia("02")
